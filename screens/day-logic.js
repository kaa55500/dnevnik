...
// Недельный блок закрывают четыре строки: без них он не уходит с экрана
// (ЦИКЛ-3.md §8). Ходьба на руках добавлена 02.09: она объявленная цель года
// (10 м к июню), а поле существовало и целью числилось, не входя при этом
// ни в закрытие блока, ни в долги — правило 9 требует строку данных.
const WEEK_REQUIRED = ['kcalAvg', 'proteinAvg', 'handstandSec', 'handstandWalk'];
